...
{
	if (key == 1)
		game->sprite.path = "so_long_mand/so_long_images_xpm/sprite_front_with_back.xpm";
	else if (key == 13)
		game->sprite.path = "so_long_mand/so_long_images_xpm/sprite_back_with_back.xpm";
	else if (key == 0)
		game->sprite.path = "so_long_mand/so_long_images_xpm/sprite_left_with_back.xpm";
	else if (key == 2)
		game->sprite.path = "so_long_mand/so_long_images_xpm/sprite_right_with_back.xpm";
}
